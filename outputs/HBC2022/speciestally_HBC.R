...
write.csv2 (combinedSpecies, "outputs/HBC2022/GBBC 2023 Species List.csv", row.names = FALSE)
...
write.csv2(participationSummary, "outputs/HBC2022/GBBC 2023 Participation.csv", row.names = FALSE)